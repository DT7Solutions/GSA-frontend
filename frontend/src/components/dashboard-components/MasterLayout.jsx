                      ...
                      <div className='col-auto'>
                          <div className='d-flex flex-wrap align-items-center gap-3'>
                              ...
                              <div className='dropdown d-none d-sm-inline-block'>
                                  ...
                                  >
                                      <img
                                          src={`${process.env.PUBLIC_URL}/adminAssets/images/lang-flag.png`}
                                          alt='Wowdash'
                                      ...
                                      <div className='max-h-400-px overflow-y-auto scroll-sm pe-8'>
                                          <div className='form-check style-check d-flex align-items-center justify-content-between mb-16'>
                                              ...
                                              >
                                                  <span className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                                                      <img
                                                          src={`${process.env.PUBLIC_URL}/adminAssets/images/flags/flag1.png`}
                                                          alt=''
                                          ...
                                          <div className='form-check style-check d-flex align-items-center justify-content-between mb-16'>
                                              ...
                                              >
                                                  <span className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                                                      <img
                                                          src={`${process.env.PUBLIC_URL}/adminAssets//images/flags/flag2.png`}
                                                          alt=''
                                                          className='w-36-px h-36-px bg-success-subtle text-success-main rounded-circle flex-shrink-0'
                                                      />
                                                      <span className='text-md fw-semibold mb-0'>
                              ...
                              <div className='dropdown'>
                                  ...
                                  >
                                      <img
                                          src={`${process.env.PUBLIC_URL}/adminAssets//images/user.png`}
                                          alt='image_user'
